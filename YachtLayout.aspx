<%@ Page Title="" Language="C#" MasterPageFile="~/Web.Master" AutoEventWireup="true" CodeBehind="YachtLayout.aspx.cs" Inherits="TayanaSystem.YachtLayout" %>
        ...
        <div class="left"> 
            ...
            <div class="left1">
                ...
                <asp:Repeater ID="rpMenu" runat="server">
                    ...
                    <ItemTemplate>
                        <li><a href="YachtLayout.aspx?id=<%#Eval("id") %>">
